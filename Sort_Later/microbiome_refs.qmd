...
- mentions how microbes have first permeate skin which is primary barreier between host and enviroment. microbiome evovle faster than genome can play fund role in host ability to adpat to enviro dist. adapt to climate change faster. 
...
- Overall, our field survey data suggest that different bacterial
   ...
   many macro systems.
>>>>>>> 4d8169c1689cd06017ac75d828c53a7850623bd7
[@Bierlich2018]
...
## Environmental Factors - Skin Microbiome

[@Hughey:2017]

- Skin microbiome of _Elutherodactylus coqui_ along an altitudinal gradient and two land use categories (intact forest vs. disturbed forest). Alpha diversity varied but not with alititude nor land use. Beta diversity (community structure), varied with site, elevation and land use, primarily due to changes in the relative abundance of certain bacterial OTUs.

[@Ellison:2019] 

- Compared skin microbiome of 2 genera of plethodontid salamander and 1 genus of frogs in montane Mexico and Guatemala. phylogenetic history strongly influences the diversity and community structure of the total bacterial microbiome (between orders), but on lower scales (within genera and species), the effect of habitat predominates.  Growing consensus that habitat exerts a strong effect on microbiome structure and composition, particularly at shallow phylogenetic scales.

[@Gajewski:2023]

- Host and environmental factors in 3 species of sympatric ranid frogs. Skin swabs from tadpoles and adults. 16S bacterial communities change across developmental stage, found microbiome communities from skin of frogs in streams or bogs differed from terrestrial. Effect of habitat use on host-associated microbiome. 

[@Garcia-Recinos:2019]

- Elutherodactylus frogs skin microbiome hypothesized to be mostly related to microhabitat use but differ by locality. Sequenced V4 region of 16S rRNA gene. Locality had greatest efffect on composition (presence/absence) rather than structure (abundance). But some suggestion that ecological disparity translates into differences in microbiome. 

## Barcoding with MinION
...
- Non-invasive swabbing technique for sampling salamanders to collect skin microbiome
